...
public class ConfigurationParameters implements Cloneable {
    ...
    public boolean useQualcommFaceDetection;
    ...
    public boolean useLaneDetection;
    public boolean useVehicleDetection;
    public AlgoWrapper algoWrapper;
    public int keyFramesPerFile;
    public int dnnWidth;
    public int dnnHeight;
    public boolean displayLaneFiducials;
    public PointF laneFiducialLeftBottom;
    public PointF laneFiducialLeftTop;
    public PointF laneFiducialRightBottom;
    public PointF laneFiducialRightTop;
    public boolean laneFiducialsSnapY;
    ...
    public static final int ColorTL = Color.RED;
    public static final int ColorTR = Color.BLUE;
    public static final int ColorBL = Color.GREEN;
    public static final int ColorBR = Color.BLACK;
    public float[] laneDetectionResults;
